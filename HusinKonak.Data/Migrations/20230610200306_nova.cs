        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_Inventories_InventoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Deliveries_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerReward", x => new { x.CustomerId, x.RewardId });
                    table.ForeignKey(
                        name: "FK_CustomerReward_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerReward_Rewards_RewardId",
                        column: x => x.RewardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountMenuItem", x => new { x.DiscountID, x.MenuItemID });
                    table.ForeignKey(
                        name: "FK_DiscountMenuItem_Discounts_DiscountID",
                        column: x => x.DiscountID,
                        principalTable: "Discounts",
                        principalColumn: "DiscountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscountMenuItem_MenuItems_MenuItemID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemMenuItem", x => new { x.MenuItemId, x.OrderItemId });
                    table.ForeignKey(
                        name: "FK_OrderItemMenuItem_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "MenuItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItemMenuItem_OrderItems_OrderItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderItemId = table.Column<int>(type: "int", nullable: false),
                    ReviewId = table.Column<int>(type: "int", nullable: false),
                    OrderItemReviewId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemReview", x => new { x.OrderItemId, x.ReviewId });
                    table.ForeignKey(
                        name: "FK_OrderItemReview_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "OrderItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItemReview_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerReward_RewardId",
                table: "CustomerReward",
                column: "RewardId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountMenuItem_MenuItemID",
                table: "DiscountMenuItem",
                column: "MenuItemID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_InventoryId",
                table: "MenuItems",
                column: "InventoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemMenuItem_OrderItemId",
                table: "OrderItemMenuItem",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemReview_ReviewId",
